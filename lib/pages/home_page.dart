...
class HomePage extends StatefulWidget {
  const HomePage({Key? key, this.onDrawerCalled}) : super(key: key);
  static String id = "Homepage";
  final Function? onDrawerCalled;
  @override
                      ...
                      return Material(
                        ...
                        child: InkWell(
                          ...
                          child: Column(children: [
                            ...
                            Text("\$" + _product.price,
                                style:
                                    TextStyle(color: AppColor.kkSecondaryColor))
                          ]),
                        ),
                      );
                    }),
